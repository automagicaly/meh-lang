...
class Lexer {
    ...
    private void scanToken() {
        ...
        switch (c) {
            ...
            case '"':
                ...
                addToken(TokenType.STRING_LITERAL, source.substring(start, current));
                advanceCurrent();
                break;
            case '/':
                // ignore comments
    ...
    private void scanNumber() {
        if (peekPrevious() == '0' && peek() == 'x') {
            ...
            addToken(TokenType.NUMBER_INTEGER, Integer.parseInt(source.substring(start + 2, current), 16));
            return;
        }
